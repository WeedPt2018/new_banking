...
local atms = {
	...
	{name="ATM", id=277, x=-1179.02, y=-1763.27, z=3.90},
    {name="ATM", id=277, x=-38.15, y=-1115.76, z=26.43},
    {name="ATM", id=277, x=387.20, y=-1001.19, z=29.41},
    {name="ATM", id=277, x=250.51, y=-826.54, z=29.79},
    {name="ATM", id=277, x=-355.73, y=-130.79, z=39.43},
    {name="ATM", id=277, x=-1390.76, y=-590.77, z=30.31},
...
if bankMenu then
	...
	if nearBank() or nearATM() then
			DisplayHelpText("Pressiona ~INPUT_PICKUP~ para acessar a conta! ~b~")
